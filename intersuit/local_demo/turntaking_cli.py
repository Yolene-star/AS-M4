...
# Remove accelerate related imports
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_path", type=str, default="checkpoints/M4-LongVA-7B-Qwen2")
    parser.add_argument("--new_query", type=str, default="Sorry to Interrupt.")
    parser.add_argument("--new_query_pos", type=int, default=20)
    args = parser.parse_args()

    model = InterSuit(pretrained=args.model_path, model_name="llava_qwen", device_map=args.device, attn_implementation="eager")

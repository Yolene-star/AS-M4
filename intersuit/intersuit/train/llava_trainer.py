...
class LLaVATrainer(Trainer):
    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if getattr(self.args, "scene_audio_projector_lr", None) is not None:
                lr_mapper["scene_audio_encoder"] = self.args.scene_audio_projector_lr
            if getattr(self.args, "streaming_av_lr", None) is not None:

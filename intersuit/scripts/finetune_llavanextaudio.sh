...
#SBATCH --gres=gpu:4
#SBATCH --output=./slurm_logs/finetune-llavanext-audio.out
#SBATCH --error=./slurm_logs/finetune-llavanext-audio.error.out
...
MID_RUN_NAME="${MID_RUN_NAME:-LongVA-7B-Qwen2-Audio}"
...
DATA_PATH="${DATA_PATH:-inputs/texts/llava_next_audio.json}"
IMAGE_FOLDER="${IMAGE_FOLDER:-inputs/images/llava-next}"
SPEECH_FOLDER="${SPEECH_FOLDER:-inputs/speech/llavanext}"

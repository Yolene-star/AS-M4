...
export AS_M4_INFERENCE_SIMPLE_AUDIO_GATE="${AS_M4_INFERENCE_SIMPLE_AUDIO_GATE:-}"
...

{
  ...
  echo "AS_M4_INFERENCE_SIMPLE_AUDIO_GATE=$AS_M4_INFERENCE_SIMPLE_AUDIO_GATE"
  echo "AS_M4_SCENE_AUDIO_CONTRASTIVE_WEIGHT=$AS_M4_SCENE_AUDIO_CONTRASTIVE_WEIGHT"
  echo "AS_M4_SCENE_AUDIO_CONTRASTIVE_MARGIN=$AS_M4_SCENE_AUDIO_CONTRASTIVE_MARGIN"

...
export AS_M4_INFERENCE_SIMPLE_AUDIO_GATE="${AS_M4_INFERENCE_SIMPLE_AUDIO_GATE:-0.25}"
export AS_M4_SCENE_AUDIO_CONTRASTIVE_WEIGHT="${AS_M4_SCENE_AUDIO_CONTRASTIVE_WEIGHT:-0.0}"
export AS_M4_SCENE_AUDIO_CONTRASTIVE_MARGIN="${AS_M4_SCENE_AUDIO_CONTRASTIVE_MARGIN:-0.2}"

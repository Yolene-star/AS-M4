...
def test_build_records_assigns_offsets_for_shift_conditions():
    records = offsets.build_records([_cache()], {"v1"}, top_k=1, min_change_quantile=0.0, min_candidate_change_margin=0.0)
...
def test_evaluate_reports_accuracy_and_margin():
    ...
    records = [
        offsets.OffsetRecord("v1", "10", "val", "original", 2, [1, 2, 3], 0.0, 1, "audio_change", 1, 1, 1, 1, 1),
        offsets.OffsetRecord("v2", "11", "val", "shift_plus_0.5", 2, [2, 3, 4], -0.5, 0, "clip_change", 1, 1, 1, 1, 1),
    ]
